...
# ---------------------------- 여기 만져야한다----------------------------
# ---------------------------- 여기 만져야한다----------------------------
def preprocess_frame(frame, target_width, target_height, apply_brightness_contrast=True, alpha=3, beta=50, enhance=True, 
...
# ---------------------------- 여기 만져야한다----------------------------
# ---------------------------- 여기 만져야한다----------------------------
def corp_video_with_blob_detection(video_path, output_path, min_radius, max_radius, apply_brightness_contrast=True, alpha=3, beta=50, 
...
output_path = 'videos/oview_last.mp4'
min_radius = 2.7
max_radius = 8
